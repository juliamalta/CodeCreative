            ...
            <div className="flex flex-col gap-8">
                ...
                <div className="hidden lg:flex">
                    <a
                        ...
                        className="bg-color-purble pointer-events-auto relative flex w-full items-center justify-center gap-3 rounded-full px-5 py-3 text-sm font-semibold text-white transition hover:border-2 hover:border-color-studio hover:bg-white hover:text-color-studio sm:w-fit sm:text-base 2xl:text-base">
