...
export function Forms3({ title, desc }: FormsProps) {
    ...
    const fieldClass =
        'w-full h-12 rounded-lg bg-color-woodsmoke3 text-white border-2 border-color-woodsmoke2 px-4 transition-all focus:border-transparent focus:ring-2 focus:ring-primary'
